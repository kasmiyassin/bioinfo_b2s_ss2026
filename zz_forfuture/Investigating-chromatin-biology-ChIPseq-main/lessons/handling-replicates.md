---
title: "Handling replicates with ChIP-seq"
author: "Meeta Mistry"
date: "Thursday, May 24th, 2019"
---
...
* Evaluating concordance between replicate peak calls
* Combining replicates to reatin only get the highly reproducible peaks
...
Common methods for handling replicates includes taking overlapping peak calls across replicates and then assessing differences in binding regions. Additionally, there are more complex methods that employ statistical testing and evaluate the reproducibility between replicates.

## Finding overlapping peaks

Use `GRanges` - readin peak files to R and `findOverlaps()`
