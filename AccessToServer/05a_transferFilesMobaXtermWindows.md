...
<img src="/AccessToServer/docs/assets/CISWork17.png" alt="Logged in screen" width="600">  
...
<img src="/AccessToServer/docs/assets/CISWork18.png" alt="Navigate the remote machine" width="600">  
...
<img src="/AccessToServer/docs/assets/CISWork19.png" alt="Follow terminal folder" width="600">  
...
<img src="/AccessToServer/docs/assets/CISWork20.png" alt="Navigate to /demo/text_files" width="600">  
...
<img src="/AccessToServer/docs/assets/CISWork21.png" alt="Download the folder “data” from the remote machine" width="600">    
...
<img src="/AccessToServer/docs/assets/CISWork22.png" alt="Download and select location" width="600">   
...
<img src="/AccessToServer/docs/assets/CISWork23.png" alt="'data' folder in the 'Documents' folder" width="600">   
...
<img src="/AccessToServer/docs/assets/CISWork24.png" alt="'Screenshots' folder on local computer" width="600">  
...
<img src="/AccessToServer/docs/assets/CISWork25.png" alt="Select screenshot from folder to upload" width="600">  
  
After this, you can now see the image, “Screenshot (1) has been transferred to the remote machine as shown below.   
  
<img src="/AccessToServer/docs/assets/CISWork26.png" alt="Screenshot transferred to the remote machine" width="600">  
...
<img src="/AccessToServer/docs/assets/CISWork27.png" alt="Document clicked and dragged to local computer" width="600">  
